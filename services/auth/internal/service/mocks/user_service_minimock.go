...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, dto *model.UserUpdateDTO) (err error)
	inspectFuncUpdate   func(ctx context.Context, dto *model.UserUpdateDTO)
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, dto *model.UserUpdateDTO) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, dto}
...
// ExpectDtoParam2 sets up expected param dto for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectDtoParam2(dto *model.UserUpdateDTO) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.dto = &dto

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the UserService.Update
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, dto *model.UserUpdateDTO)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, dto *model.UserUpdateDTO) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, dto *model.UserUpdateDTO) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, dto},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, dto *model.UserUpdateDTO) (err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, dto)
	}

	mm_params := UserServiceMockUpdateParams{ctx, dto}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, dto}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.dto != nil && !minimock.Equal(*mm_want_ptrs.dto, mm_got.dto) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter dto, want: %#v, got: %#v%s\n", *mm_want_ptrs.dto, mm_got.dto, minimock.Diff(*mm_want_ptrs.dto, mm_got.dto))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, dto)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v", ctx, dto)
	return
}
