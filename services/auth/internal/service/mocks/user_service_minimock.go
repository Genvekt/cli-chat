...
type UserServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, id int64, updateFunc func(user *model.User) error) (err error)
	inspectFuncUpdate   func(ctx context.Context, id int64, updateFunc func(user *model.User) error)
...
func NewUserServiceMock(t minimock.Tester) *UserServiceMock {
	...
	m.GetListMock = mUserServiceMockGetList{mock: m}
	m.GetListMock.callArgs = []*UserServiceMockGetListParams{}
...
type mUserServiceMockGetList struct {
	optional           bool
	mock               *UserServiceMock
	defaultExpectation *UserServiceMockGetListExpectation
	expectations       []*UserServiceMockGetListExpectation

	callArgs []*UserServiceMockGetListParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// UserServiceMockGetListExpectation specifies expectation struct of the UserService.GetList
type UserServiceMockGetListExpectation struct {
	mock      *UserServiceMock
	params    *UserServiceMockGetListParams
	paramPtrs *UserServiceMockGetListParamPtrs
	results   *UserServiceMockGetListResults
	Counter   uint64
}
...
type UserServiceMockGetListResults struct {
	upa1 []*model.User
	err  error
}
...
// It is NOT RECOMMENDED to use this option by default unless you really need it, as it helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetList *mUserServiceMockGetList) Optional() *mUserServiceMockGetList {
...
func (mmGetList *mUserServiceMockGetList) Expect(ctx context.Context, names []string) *mUserServiceMockGetList {
	...
	if mmGetList.defaultExpectation == nil {
		mmGetList.defaultExpectation = &UserServiceMockGetListExpectation{}
	}
...
// ExpectCtxParam1 sets up expected param ctx for UserService.GetList
func (mmGetList *mUserServiceMockGetList) ExpectCtxParam1(ctx context.Context) *mUserServiceMockGetList {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("UserServiceMock.GetList mock is already set by Set")
	}
	...
	if mmGetList.defaultExpectation.params != nil {
		mmGetList.mock.t.Fatalf("UserServiceMock.GetList mock is already set by Expect")
	}
...
// Return sets up results that will be returned by UserService.GetList
func (mmGetList *mUserServiceMockGetList) Return(upa1 []*model.User, err error) *UserServiceMock {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("UserServiceMock.GetList mock is already set by Set")
	}

	if mmGetList.defaultExpectation == nil {
		mmGetList.defaultExpectation = &UserServiceMockGetListExpectation{mock: mmGetList.mock}
	}
	mmGetList.defaultExpectation.results = &UserServiceMockGetListResults{upa1, err}
...
func (mmGetList *mUserServiceMockGetList) Set(f func(ctx context.Context, names []string) (upa1 []*model.User, err error)) *UserServiceMock {
	...
	if len(mmGetList.expectations) > 0 {
		mmGetList.mock.t.Fatalf("Some expectations are already set for the UserService.GetList method")
	}
...
// Then sets up UserService.GetList return parameters for the expectation previously defined by the When method
func (e *UserServiceMockGetListExpectation) Then(upa1 []*model.User, err error) *UserServiceMock {
	e.results = &UserServiceMockGetListResults{upa1, err}
	return e.mock
}

// Times sets number of times UserService.GetList should be invoked
func (mmGetList *mUserServiceMockGetList) Times(n uint64) *mUserServiceMockGetList {
	if n == 0 {
		mmGetList.mock.t.Fatalf("Times of UserServiceMock.GetList mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmGetList.expectedInvocations, n)
	return mmGetList
}

func (mmGetList *mUserServiceMockGetList) invocationsDone() bool {
...
func (mmGetList *UserServiceMock) GetList(ctx context.Context, names []string) (upa1 []*model.User, err error) {
	...
	if mmGetList.GetListMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			mmGetList.t.Errorf("UserServiceMock.GetList got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmGetList.GetListMock.defaultExpectation.results
		if mm_results == nil {
			mmGetList.t.Fatal("No results are set for the UserServiceMock.GetList")
		}
...
// GetListAfterCounter returns a count of finished UserServiceMock.GetList invocations
func (mmGetList *UserServiceMock) GetListAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetList.afterGetListCounter)
}

// GetListBeforeCounter returns a count of UserServiceMock.GetList invocations
func (mmGetList *UserServiceMock) GetListBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetList.beforeGetListCounter)
}

// Calls returns a list of arguments used in each call to UserServiceMock.GetList.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetList *mUserServiceMockGetList) Calls() []*UserServiceMockGetListParams {
	mmGetList.mutex.RLock()

	argCopy := make([]*UserServiceMockGetListParams, len(mmGetList.callArgs))
...
// the number of defined expectations
func (m *UserServiceMock) MinimockGetListDone() bool {
...
func (m *UserServiceMock) MinimockGetListInspect() {
	for _, e := range m.GetListMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserServiceMock.GetList with params: %#v", *e.params)
		}
	}
	...
	if m.GetListMock.defaultExpectation != nil && afterGetListCounter < 1 {
		if m.GetListMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to UserServiceMock.GetList")
		} else {
			m.t.Errorf("Expected call to UserServiceMock.GetList with params: %#v", *m.GetListMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetListMock.invocationsDone() && afterGetListCounter > 0 {
		m.t.Errorf("Expected %d calls to UserServiceMock.GetList but found %d calls",
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, updateFunc func(user *model.User) error) *mUserServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserServiceMockUpdateParams{ctx, id, updateFunc}
...
// ExpectUpdateFuncParam3 sets up expected param updateFunc for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectUpdateFuncParam3(updateFunc func(user *model.User) error) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.paramPtrs.updateFunc = &updateFunc

	return mmUpdate
}

// Inspect accepts an inspector function that has same arguments as the UserService.Update
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, updateFunc func(user *model.User) error)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, updateFunc func(user *model.User) error) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, updateFunc func(user *model.User) error) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &UserServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserServiceMockUpdateParams{ctx, id, updateFunc},
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, updateFunc func(user *model.User) error) (err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, id, updateFunc)
	}

	mm_params := UserServiceMockUpdateParams{ctx, id, updateFunc}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockUpdateParams{ctx, id, updateFunc}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.updateFunc != nil && !minimock.Equal(*mm_want_ptrs.updateFunc, mm_got.updateFunc) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter updateFunc, want: %#v, got: %#v%s\n", *mm_want_ptrs.updateFunc, mm_got.updateFunc, minimock.Diff(*mm_want_ptrs.updateFunc, mm_got.updateFunc))
			}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, id, updateFunc)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserServiceMock.Update. %v %v %v", ctx, id, updateFunc)
	return
}
