...
func (mmGetByUsername *UserRepositoryMock) GetByUsername(ctx context.Context, username string) (up1 *model.User, err error) {
	...
	if mmGetByUsername.GetByUsernameMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetByUsername.t.Errorf("UserRepositoryMock.GetByUsername got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.username != nil && !minimock.Equal(*mm_want_ptrs.username, mm_got.username) {
				mmGetByUsername.t.Errorf("UserRepositoryMock.GetByUsername got unexpected parameter username, want: %#v, got: %#v%s\n", *mm_want_ptrs.username, mm_got.username, minimock.Diff(*mm_want_ptrs.username, mm_got.username))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetByUsername.t.Errorf("UserRepositoryMock.GetByUsername got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *UserRepositoryMock) MinimockGetByUsernameInspect() {
	for _, e := range m.GetByUsernameMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.GetByUsername with params: %#v", *e.params)
		}
	}
	...
	if m.GetByUsernameMock.defaultExpectation != nil && afterGetByUsernameCounter < 1 {
		if m.GetByUsernameMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to UserRepositoryMock.GetByUsername")
		} else {
			m.t.Errorf("Expected call to UserRepositoryMock.GetByUsername with params: %#v", *m.GetByUsernameMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetByUsernameMock.invocationsDone() && afterGetByUsernameCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.GetByUsername but found %d calls",
			mm_atomic.LoadUint64(&m.GetByUsernameMock.expectedInvocations), afterGetByUsernameCounter)
	}
}
...
func (mmGetList *mUserRepositoryMockGetList) Return(upa1 []*model.User, err error) *UserRepositoryMock {
	if mmGetList.mock.funcGetList != nil {
		mmGetList.mock.t.Fatalf("UserRepositoryMock.GetList mock is already set by Set")
	}
	...
	mmGetList.defaultExpectation.results = &UserRepositoryMockGetListResults{upa1, err}
...
func (e *UserRepositoryMockGetListExpectation) Then(upa1 []*model.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetListResults{upa1, err}
	return e.mock
}
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, updateFunc func(user *model.User) error) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, id, updateFunc}
...
// ExpectUpdateFuncParam3 sets up expected param updateFunc for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectUpdateFuncParam3(updateFunc func(user *model.User) error) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, updateFunc func(user *model.User) error)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, updateFunc func(user *model.User) error) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, updateFunc func(user *model.User) error) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, id, updateFunc},
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, updateFunc func(user *model.User) error) (err error) {
	...
	mm_params := UserRepositoryMockUpdateParams{ctx, id, updateFunc}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, id, updateFunc}
	...
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, id, updateFunc)
	return
}
