...
func (mmExpire *mUserCacheMockExpire) Expect(ctx context.Context, id int64, timeout time.Duration) *mUserCacheMockExpire {
	...
	mmExpire.defaultExpectation.params = &UserCacheMockExpireParams{ctx, id, timeout}
...
// ExpectTimeoutParam3 sets up expected param timeout for UserCache.Expire
func (mmExpire *mUserCacheMockExpire) ExpectTimeoutParam3(timeout time.Duration) *mUserCacheMockExpire {
	if mmExpire.mock.funcExpire != nil {
		mmExpire.mock.t.Fatalf("UserCacheMock.Expire mock is already set by Set")
	}
	...
	mmExpire.defaultExpectation.paramPtrs.timeout = &timeout

	return mmExpire
}

// Inspect accepts an inspector function that has same arguments as the UserCache.Expire
func (mmExpire *mUserCacheMockExpire) Inspect(f func(ctx context.Context, id int64, timeout time.Duration)) *mUserCacheMockExpire {
...
func (mmExpire *mUserCacheMockExpire) Set(f func(ctx context.Context, id int64, timeout time.Duration) (err error)) *UserCacheMock {
	if mmExpire.defaultExpectation != nil {
...
// Then helper
func (mmExpire *mUserCacheMockExpire) When(ctx context.Context, id int64, timeout time.Duration) *UserCacheMockExpireExpectation {
	if mmExpire.mock.funcExpire != nil {
		mmExpire.mock.t.Fatalf("UserCacheMock.Expire mock is already set by Set")
	}
	...
	expectation := &UserCacheMockExpireExpectation{
		mock:   mmExpire.mock,
		params: &UserCacheMockExpireParams{ctx, id, timeout},
	}
...
// Expire implements repository.UserCache
func (mmExpire *UserCacheMock) Expire(ctx context.Context, id int64, timeout time.Duration) (err error) {
	...
	if mmExpire.inspectFuncExpire != nil {
		mmExpire.inspectFuncExpire(ctx, id, timeout)
	}

	mm_params := UserCacheMockExpireParams{ctx, id, timeout}
	...
	if mmExpire.ExpireMock.defaultExpectation != nil {
		...
		mm_got := UserCacheMockExpireParams{ctx, id, timeout}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.timeout != nil && !minimock.Equal(*mm_want_ptrs.timeout, mm_got.timeout) {
				mmExpire.t.Errorf("UserCacheMock.Expire got unexpected parameter timeout, want: %#v, got: %#v%s\n", *mm_want_ptrs.timeout, mm_got.timeout, minimock.Diff(*mm_want_ptrs.timeout, mm_got.timeout))
			}
	...
	if mmExpire.funcExpire != nil {
		return mmExpire.funcExpire(ctx, id, timeout)
	}
	mmExpire.t.Fatalf("Unexpected call to UserCacheMock.Expire. %v %v %v", ctx, id, timeout)
	return
}
