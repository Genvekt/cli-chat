...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, name string, usernames []string) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, name, usernames}
...
// ExpectNameParam2 sets up expected param name for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectNameParam2(name string) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
// ExpectUsernamesParam3 sets up expected param usernames for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectUsernamesParam3(usernames []string) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, name string, usernames []string)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, name string, usernames []string) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, name string, usernames []string) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:   mmCreate.mock,
		params: &ChatServiceMockCreateParams{ctx, name, usernames},
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, name string, usernames []string) (i1 int64, err error) {
	mm_atomic.AddUint64(&mmCreate.beforeCreateCounter, 1)
	defer mm_atomic.AddUint64(&mmCreate.afterCreateCounter, 1)

	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, name, usernames)
	}

	mm_params := ChatServiceMockCreateParams{ctx, name, usernames}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, name, usernames}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, name, usernames)
	}
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v %v", ctx, name, usernames)
	return
}
